...
> **Статус эксперимента**: Это незавершённый эксперимент для ELAN
> `04f3:0c77`. Рабочая комбинация quirks не подтверждена, поэтому документ
> нельзя считать готовой инструкцией по установке. Техническая перепроверка
