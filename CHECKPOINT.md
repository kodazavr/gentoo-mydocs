...
- **TPM2-разблокировка LUKS**: токен перезачислен на PCR 7 (sha256) 2026-09-14,
  проверена реальной загрузкой. Наблюдение: смена cmdline/UKI совпадала с
  поломкой анлока (эпизоды марта/апреля и 2026-09-14), повторное зачисление
  восстанавливало работу. Точный measurement path прошивки не подтверждён —
  прямого before/after-замера PCR 7 не было. Решение 2026-09-14 — остаёмся
