...
> **Статус:** системный план, не применённый на 2026-09-22. Проверено аудитом:
> `nvme0n1` — единый LUKS-раздел, не открыт; `/etc/crypttab` отсутствует;
> таймеры btrbk/borg не настроены; Arch UKI остаются в ESP. Перед выполнением
> заново проверь имена устройств, точки монтирования и состояние обоих дисков.
