...
- смена cmdline внутри UKI — на прошивке asus-b5402 совпала с поломкой
  (проверяется слепками PCR, см. раздел 5); по канону cmdline измеряется
  в PCR 8/12, то есть поведение прошивки шире норматива;
...
ломала: переход 7.2.2 → 7.2.5 прошёл без последствий, сломалась первая
с момента настройки системы смена cmdline (2026-09-14).
...
- 2026-09-14 — первая смена cmdline (добавлен `audit_backlog_limit`)
  сломала анлок; перезачисление на PCR 7 восстановило, проверено
